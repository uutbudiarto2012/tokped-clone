  ...
  return (
    <div className='flex items-end gap-2 text-gray-600'>
      <div className='flex-1'>
        <span className='block mb-2 text-sm font-semibold'>Nomor Telepon</span>
        <div className='border h-10 px-2 rounded-lg flex items-center'>
          ...
          />
          <div className='w-6 h-6 flex items-center justify-center bg-red-400 relative'>
            <Image src='/images/category/1.png' alt='provider' fill />
          </div>
        </div>
      </div>
      <div className='flex-1'>
        ...
        <div className='border px-2 h-10 rounded-lg flex'>
          {/* dropdown */}
          <input type='tel' className='w-full text-xs outline-none' />
        </div>
      </div>
